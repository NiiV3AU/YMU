...
progressbar_get_local_sha256_button.pack(pady = 5, padx = 5, expand = False, fill = "x", side = "bottom", anchor = "s"
)
progressbar_get_local_sha256_button.set(0)
...
progress_prcnt_label.pack(pady = 5, padx = 5, expand = False, fill = None, anchor = "s", side = "bottom")
...
download_button.pack(pady = 10, padx = 5, expand = True, fill = None,)
...
inject_button.pack(pady = 10, padx = 5, expand = True, fill = None,)
